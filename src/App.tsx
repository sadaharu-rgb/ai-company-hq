            ...
            <div className="ml-3 flex items-center gap-1 bg-gray-100 rounded-full p-0.5">
              <button
                ...
                className={`text-[11px] px-3 py-1 rounded-full transition-colors ${
                  画面モード === 'HQ' ? 'bg-white text-gray-900 shadow-sm font-semibold' : 'text-gray-500'
                }`}
              >🏢 HQ</button>
              <button
                onClick={() => 画面モード設定('Marketing')}
                className={`text-[11px] px-3 py-1 rounded-full transition-colors ${
                  画面モード === 'Marketing' ? 'bg-white text-gray-900 shadow-sm font-semibold' : 'text-gray-500'
                }`}
              >📣 Marketing</button>
            </div>
          </div>
